...
```{r}
gold <- read_tsv("../library/BREXIT_V20190522_DEDUP/gold/adjudicated.tsv",
                 show_col_types = FALSE) %>% 
  select(-c("...1"))

random1000 <- read_tsv("../library/BREXIT_V20190522_DEDUP/gold/random-1000.tsv",
              show_col_types = FALSE, col_types = "clll") %>%
